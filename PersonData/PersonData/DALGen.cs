...
namespace People
{
    ...
    public abstract class DALGen
    {
        ...
        protected string strSqlConn = "Data Source=DESKTOP-HPQE6AA\\SQLEXPRESS;Initial Catalog=Sajat;Integrated Security=SSPI"; //Windows Authentication esetén
        ...
        //es teritunk vissza
        protected SqlDataReader ExecuteReader(string sQuery, string[] parameterNames, string[] parameterValues, ref string errMess)
        {
